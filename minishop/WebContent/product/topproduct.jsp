...
<body>
	...
	<% ArrayList<ProductDTO> toplist = (ArrayList<ProductDTO>)request.getAttribute("toplist"); %>
		...
		%>
			...
			<figure> <img src="/minishop/images/product/<%=pro.getImg_gen_file_nm() %>" alt="image01" /> <input
				type="radio" name="radio-set" checked="checked" /> <figcaption>
			<span><%=pro.getPrd_nm() %></span></figcaption> 
		<%} %>
			</figure>
